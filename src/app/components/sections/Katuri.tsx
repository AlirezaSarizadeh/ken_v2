...
export default function Section8({
  ...
  return (
    <div className="w-full min-h-full flex flex-col items-center justify-center relative py-16 md:py-0 overflow-hidden" id="katori">
      {/* Background */}
      ...
      <div className="w-full fixed bottom-8 left-0 right-0 flex flex-col items-center justify-end z-50 pointer-events-none">
        ...
        <motion.button
          ...
          aria-controls="main-content-section8"
        >
          <motion.div
            className="relative"
            animate={{ y: [0, -10, 0] }}
